...
def main(cfg: DictConfig):
    ...
    model = ResNetForKoopmanEstimation(cfg.modeling.teacher.checkpoint_path, out_size=(16, 16)) if cfg.modeling.type == "resnet" else ViTForImageClassification.from_pretrained(cfg.modeling.teacher.checkpoint_path)
