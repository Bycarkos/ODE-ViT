...
def main(cfg: DictConfig):
    ...
    teacher_model = ResNetForImageClassification.from_pretrained(checkpoint_path) if cfg.modeling.type == "resnet" else ViTForImageClassification.from_pretrained(checkpoint_path, num_labels=len(train_dataset.classes))
