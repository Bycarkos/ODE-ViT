...
def main(cfg: DictConfig):
    ...
    model = ResNetForImageClassification.from_pretrained("resnet50") if cfg.modeling.type == "resnet" else ViTForImageClassification.from_pretrained("google/vit-base-patch16-224-in21k", num_labels=len(train_dataset.classes))
...
if __name__ == "__main__":
    ...
    delete_corrupted_images("/data/users/cboned/data/Generic/imagenet100/train")
