...
def main(cfg: DictConfig):
    ...
    resolution = cfg.setup.dict.resolution
    model = ResNetForKoopmanEstimation(cfg.modeling.teacher.checkpoint_path, out_size=resolution) if cfg.modeling.type == "resnet" else ViTForImageClassification.from_pretrained(cfg.modeling.teacher.checkpoint_path)
