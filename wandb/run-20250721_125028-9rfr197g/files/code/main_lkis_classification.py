...
def main(cfg: DictConfig):
    ...
    model = ResNetForKoopmanEstimation(cfg.modeling.teacher.checkpoint_path, out_size=(7, 7)) if cfg.modeling.type == "resnet" else ViTForImageClassification.from_pretrained(cfg.modeling.teacher.checkpoint_path)
