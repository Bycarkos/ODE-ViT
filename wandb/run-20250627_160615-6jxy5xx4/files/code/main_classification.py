...
def main(cfg: DictConfig):
    ...
    model = ResNetForImageClassification.from_pretrained("resnet50") if cfg.modeling.type == "resnet" else ViTForImageClassification.from_pretrained("google/vit-base-patch16-224-in21k")
