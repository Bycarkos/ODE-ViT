...
from models.wrapper_models import EDOEncoderWrapperClassification, EDOEncoderWrapperWithMemory
## Common packages
import torch
...
def main(cfg: DictConfig):
    ...
    model = EDOEncoderWrapperWithMemory(encoder=model, n_classes=len(train_dataset.classes), steps=12)
