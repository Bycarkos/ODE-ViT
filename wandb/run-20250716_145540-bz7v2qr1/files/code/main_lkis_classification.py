...
def main(cfg: DictConfig):
    ...
    model = ResNetForKoopmanEstimation(cfg.modeling.teacher.checkpoint_path, out_channels=768, out_size=(4, 4)) if cfg.modeling.type == "resnet" else ViTForImageClassification.from_pretrained(cfg.modeling.teacher.checkpoint_path)
