...
def main(cfg: DictConfig):
    ...
    checkpoint_path = cfg.modeling.teacher.checkpoint_path
    teacher_model = ResNetForKoopmanEstimation(checkpoint_path, out_size=(7, 7)) if cfg.modeling.type == "resnet" else ViTForImageClassification.from_pretrained(cfg.modeling.teacher.checkpoint_path)
    ...
    for i in range(len(features_to_keep)):
        ...
        U_i, S_i, Vt_i = utils.perform_pca_lowrank(embeddings_to_compute_pca, n_eigenvectors=3, center=False)
